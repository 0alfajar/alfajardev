import imgHero from "../imports/Home/image-hero.webp";
import imgProject1 from "../imports/image.webp";
import imgProject2 from "../imports/image-1.webp";
import imgProject3 from "../imports/image-4.webp";
import imgProject4 from "../imports/image-3.webp";
import imgSafarly from "../imports/image-safarly.webp";
    ...
    <div className="flex flex-col gap-5 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <span
          ...
          style={{ fontFamily: "'JarFont', sans-serif", fontSize: "clamp(32px, 2.5vw, 36px)" }}
        >
          {title}
        </span>
      </div>
...
export default function App() {
  return (
    <div className="min-h-screen bg-white" style={{ fontFamily: "'JarFont', sans-serif" }}>

      {/* ── HERO ── */}
      <section className="relative w-full overflow-hidden" style={{ height: "clamp(480px, 60vw, 700px)" }}>
        <img src={imgHero} alt="Alfajar" fetchPriority="high" decoding="async" className="absolute inset-0 w-full h-full object-cover object-top" />
      ...
      <section className="px-8 py-16 md:px-14 md:py-20 max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row items-start justify-between gap-10">
          <p
            ...
            style={{ fontFamily: "'JarFont', sans-serif", fontSize: "clamp(30px, 2.2vw, 36px)", fontWeight: 500 }}
          >
          ...
          <div className="flex flex-col items-end gap-6 max-w-[380px]">
            <p
              ...
              style={{ fontFamily: "'JarFont', sans-serif", fontSize: "clamp(28px, 1.6vw, 32px)", fontWeight: 300 }}
            >
      ...
      <section className="px-8 pb-20 md:px-14 max-w-[1400px] mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-12">
          <h2
            ...
            style={{ fontSize: "clamp(54px, 8vw, 100px)", fontWeight: 500 }}
          >
            My Works
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <ProjectCard 
            image={imgSafarly} 
            title="Safarly - AI Travel Companion" 
            bg="white"
          ...
          <ProjectCard 
            image={imgProject2} 
            title="Curvature Early Detection" 
            link="https://github.com/0alfajar/PKM_CURVED" 
          />
          <ProjectCard 
            image={imgProject3} 
            title="National Library Collaboration Portal" 
            link="https://github.com/0alfajar/kerjasama_perpusnas" 
          />
          <ProjectCard 
            image={imgProject4} 
            title="Hafidz Tracker" 
            link="https://github.com/0alfajar/hafidz_tracker" 
          />
        </div>
      ...
      <section className="bg-white border-t border-gray-100">
        <div className="px-8 py-16 md:px-14 max-w-[1400px] mx-auto">
          <p className="text-black mb-2" style={{ fontFamily: "'JarFont', sans-serif", fontSize: "clamp(28px, 1.2vw, 32px)" }}>
            That's all for now.
          </p>
          <div className="mb-10">
            <h2 className="text-black leading-tight" style={{ fontSize: "clamp(54px, 6vw, 77px)", fontWeight: 400 }}>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-10">
              <div>
                <p className="text-[#7e7e7e] mb-1" style={{ fontSize: "28px" }}>Email:</p>
                <a
                  href="mailto:alfajardev@gmail.com"
                  className="text-black hover:opacity-70 transition-opacity"
                  style={{ fontSize: "clamp(32px, 1.8vw, 40px)", textDecoration: "none" }}
                >
                  alfajardev@gmail.com
                </a>
              </div>
              <div>
                <p className="text-[#7e7e7e] mb-1" style={{ fontSize: "28px" }}>Github:</p>
                <a
